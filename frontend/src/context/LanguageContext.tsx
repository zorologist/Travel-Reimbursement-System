...
const arabicErrors: Record<string, string> = {
  ...
  INVALID_CREDENTIALS: "اسم مستخدم الويندوز أو كلمة المرور غير صحيحة.",
  TOO_MANY_ATTEMPTS: "توجد محاولات تسجيل دخول غير صحيحة كثيرة جداً. حاول مرة أخرى بعد 5 دقائق.",
  DIRECTORY_USER_NOT_REGISTERED: "تم قبول حساب الويندوز، لكنه غير مسجل في نظام تعويضات السفر. تواصل مع الدعم الفني.",
  DIRECTORY_UNAVAILABLE: "خدمة تسجيل الدخول بالشركة غير متاحة حالياً. حاول بعد قليل أو تواصل مع الدعم الفني.",
  DIRECTORY_ACCOUNT_LOCKED: "حساب الويندوز مقفل. انتظر حتى يتم فتحه أو تواصل مع الدعم الفني.",
  DIRECTORY_ACCOUNT_DISABLED: "حساب الويندوز معطل. تواصل مع الدعم الفني.",
  DIRECTORY_ACCOUNT_EXPIRED: "انتهت صلاحية حساب الويندوز. تواصل مع الدعم الفني.",
  DIRECTORY_PASSWORD_EXPIRED: "انتهت صلاحية كلمة مرور الويندوز. قم بتغييرها ثم حاول مرة أخرى.",
  DIRECTORY_PASSWORD_CHANGE_REQUIRED: "يجب تغيير كلمة مرور الويندوز قبل تسجيل الدخول إلى النظام.",
  DIRECTORY_ACCOUNT_RESTRICTED: "لا يمكن لهذا الحساب تسجيل الدخول من هذا الجهاز أو في هذا الوقت. تواصل مع الدعم الفني.",
